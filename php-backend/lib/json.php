 ...
 *
 * Accepts a DateTimeInterface, a millisecond epoch, or a 'Y-m-d H:i:s.v' string as MySQL returns it.
 */
...
/** Parse a MySQL DATETIME(3) string (UTC) into a millisecond epoch. */
...
/** Format a millisecond epoch as a MySQL DATETIME(3) string in UTC. */
